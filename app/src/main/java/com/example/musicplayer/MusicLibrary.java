...
public class MusicLibrary {
    ...
    public static void initializeDatabase(Context context) {
        ...
        try {
            ...
            e.printStackTrace();
            initialized = true; // Set to true to prevent infinite retries
        }
    }
    ...
    private static Song convertToSong(SongEntity entity) {
        ...
        try {
            ...
            e.printStackTrace();
            // Fallback pentru cazuri de eroare
    ...
    public static List<Song> getSongList(Context context) {
        try {
            ...
            // Adaugă și melodiile cloud din Firestore
            loadCloudSongs(context, songs);
    ...
    private static void loadCloudSongs(Context context, List<Song> songs) {
        String userId = FirebaseAuth.getInstance().getCurrentUser() != null ? 
            FirebaseAuth.getInstance().getCurrentUser().getUid() : null;
        
        if (userId == null) return; // Nu suntem logați, nu încărcăm melodiile cloud
    ...
    public static List<String> getUniqueArtists(Context context) {
        initializeDatabase(context);
        AppDatabase database = AppDatabase.getInstance(context);
        return database.songDao().getUniqueArtists();
    }
}